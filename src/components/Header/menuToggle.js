...
svg path {
    fill: ${props => props.light ? "#fff" : "var(--secondary)"};
...
const MenuToggle = ({ clickHandler, open, light }) => {

    return (
        <Toggle onClick={clickHandler} className={`${open ? "mob-nav-open" : "mob-nav-closed"}`} light={light}>
