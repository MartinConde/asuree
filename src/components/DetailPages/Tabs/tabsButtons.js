...
const SingleTab = styled.div`
  ...
  padding: ${props => (props.active ? "15px 10px" : "10px")};
  ...
  path {
    transition: all 0.3s ease-out;
    fill: ${props => (props.active ? "var(--primary)" : "var(--secondary)")};
  }
...
export default function Tabs({ clickHandler, active }) {
  return (
    <TabsWrapper>
      <SingleTab onClick={clickHandler} active={active === 0} id={0}>
        <SingleTabContent>
      ...
      <SingleTab onClick={clickHandler} active={active === 1} id={1}>
        <SingleTabContent>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M26.151 24.172c6.042-12.77 21.296-18.221 34.066-12.179 12.774 6.045 18.225 21.296 12.18 34.069L49.274 94.925 26.151 46.062a25.592 25.592 0 010-21.89zm2.468 20.727l20.655 43.639L69.93 44.899c5.399-11.416.53-25.038-10.881-30.435-11.408-5.396-25.026-.531-30.43 10.876a22.902 22.902 0 000 19.559z" />
            <path d="M52.033 23.754a2.56 2.56 0 00-2.562-2.557 2.555 2.555 0 000 5.11 2.558 2.558 0 002.562-2.553z" />
      ...
      <SingleTab onClick={clickHandler} active={active === 2} id={2}>
        <SingleTabContent>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M26.151 24.172c6.042-12.77 21.296-18.221 34.066-12.179 12.774 6.045 18.225 21.296 12.18 34.069L49.274 94.925 26.151 46.062a25.592 25.592 0 010-21.89zm2.468 20.727l20.655 43.639L69.93 44.899c5.399-11.416.53-25.038-10.881-30.435-11.408-5.396-25.026-.531-30.43 10.876a22.902 22.902 0 000 19.559z" />
            <path d="M52.033 23.754a2.56 2.56 0 00-2.562-2.557 2.555 2.555 0 000 5.11 2.558 2.558 0 002.562-2.553z" />
      ...
      <SingleTab onClick={clickHandler} active={active === 3} id={3}>
        <SingleTabContent>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M26.151 24.172c6.042-12.77 21.296-18.221 34.066-12.179 12.774 6.045 18.225 21.296 12.18 34.069L49.274 94.925 26.151 46.062a25.592 25.592 0 010-21.89zm2.468 20.727l20.655 43.639L69.93 44.899c5.399-11.416.53-25.038-10.881-30.435-11.408-5.396-25.026-.531-30.43 10.876a22.902 22.902 0 000 19.559z" />
            <path d="M52.033 23.754a2.56 2.56 0 00-2.562-2.557 2.555 2.555 0 000 5.11 2.558 2.558 0 002.562-2.553z" />
      ...
      <SingleTab onClick={clickHandler} active={active === 4} id={4}>
        <SingleTabContent>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M26.151 24.172c6.042-12.77 21.296-18.221 34.066-12.179 12.774 6.045 18.225 21.296 12.18 34.069L49.274 94.925 26.151 46.062a25.592 25.592 0 010-21.89zm2.468 20.727l20.655 43.639L69.93 44.899c5.399-11.416.53-25.038-10.881-30.435-11.408-5.396-25.026-.531-30.43 10.876a22.902 22.902 0 000 19.559z" />
            <path d="M52.033 23.754a2.56 2.56 0 00-2.562-2.557 2.555 2.555 0 000 5.11 2.558 2.558 0 002.562-2.553z" />
