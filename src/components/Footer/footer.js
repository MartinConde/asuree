    ...
    return (
        <FooterWrapper>
            <FooterContent>
                ...
                <FooterContentMain>
                    <ProvinceWrapper>
                        <SectionTitle>Provinzen</SectionTitle>
                        <Provinces>
                            {provinces.allWpDestination.edges.map(({ node }) => (
                                node.ACF_Destinations.gyms && <Link key={node.title} to={`/destination/${node.slug}`}>{node.title}</Link>
                            ))}
                        </Provinces>
                    </ProvinceWrapper>
            ...
            <BottomWrapper>
                © {new Date().getFullYear()} Asuree, Alle Rechte vorbehalten | <Link to="/">Impressum</Link> | <Link to="/">Datenschutz</Link>
            </BottomWrapper>
        </FooterWrapper>
    )
}
